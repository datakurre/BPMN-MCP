...
- **Runtime:** Node.js ≥ 16
- **Key deps:** `@modelcontextprotocol/sdk`, `bpmn-js`, `jsdom`, `camunda-bpmn-moddle`, `@types/bpmn-moddle`
- **Test:** Vitest
...
3. **22 MCP tools** are exposed (see "Tool Naming" below).
...
- **Utility tools** use flat names: `delete_diagram`, `list_diagrams`, `clone_diagram`, `layout_diagram`, `get_element_properties`
